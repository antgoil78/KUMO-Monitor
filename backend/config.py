...
SNOWFLAKE_STATEMENT_TIMEOUT_SECONDS = int(os.getenv("SNOWFLAKE_STATEMENT_TIMEOUT_SECONDS", "1200"))
...
KUMO_SHARED_LOCK_SYNC_SECONDS = int(os.getenv("KUMO_SHARED_LOCK_SYNC_SECONDS", "1"))
